...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            ...
            <a href="ClienteControlador?action=add" type="button" class="btn btn-outline-success"><i class="fas fa-plus-circle"></i>Nuevo</a>  
            ...
            <table class="table1">
                ...
                <c:forEach var="item" items="${clientes}">
                    <tr>
                        ...
                        <td><a href="ClienteControlador?action=delete&id=${item.id}" onclick="return(confirm('Estas seguro??'))"><i class="fas fa-trash-alt"></i>Eliminar</a></td>
                    </tr> 
